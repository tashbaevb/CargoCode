...
from .serializers import (CompanyDriverSerializer, CompanySerializer,
                          DriverSerializer, RegisterSerializer, UserSerializer)
        ...
        return Response(
            {
                "driver": DriverSerializer(
                    driver, context=self.get_serializer_context()
                ).data,
...
class CompanyDriverRegisterAPI(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "driver": CompanyDriverSerializer(
                    company_driver, context=self.get_serializer_context()
                ).data,
        ...
        return Response(
            {
                "company": CompanySerializer(
                    company, context=self.get_serializer_context()
                ).data,
